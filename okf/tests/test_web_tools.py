...
from aws_reference_agent.tools.context import clear_web_state, set_web_state
from aws_reference_agent.tools.web_tools import fetch_url
from aws_reference_agent.web.fetcher import Page
...
def test_seed_fetch_succeeds_and_records_link_depth():
    _set_state()
    with patch(
        "aws_reference_agent.tools.web_tools.fetch_and_parse",
        return_value=_page(
    ...
    from aws_reference_agent.tools.context import get_web_state
