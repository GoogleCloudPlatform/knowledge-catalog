...
"""Unit tests for the Context Learning Agent."""
...
# Add samples/ to sys.path so `context_learning_agent` is importable as a package.
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", ".."))

from context_learning_agent.agent import (  # noqa: E402
...
class TestGetAgentTrajectories(unittest.TestCase):
    ...
    @patch("context_learning_agent.agent.cloud_logging")
