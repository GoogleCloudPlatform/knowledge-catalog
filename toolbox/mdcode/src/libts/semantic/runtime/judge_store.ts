...
// decision for whoever embeds the runtime, so an application asks for it (the
// agent under demo/semantic-model/agent does) and the curation CLI does not
// offer it. It holds two things:
//
